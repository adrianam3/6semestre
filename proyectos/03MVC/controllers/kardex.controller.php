...
switch ($_GET["op"]) {
    ...
    case 'todos': //TODO: Procedimeinto para cargar todos las datos de los kardex
    ...
    case 'uno':
        ...
        break;
        //TODO: Procedimeinto para insertar registros en el  kardex en la base de datos
    case 'insertar':
        $Estado = $_POST["Estado"];
        ...
        break;
        //TODO: Procedimeinto para actualziar el  kardex en la base de datos
    case 'actualizar':
        $idKardex = $_POST["idKardex"];
        $Estado = $_POST["Estado"];
        $Fecha_Transaccion = $_POST["Fecha_Transaccion"];
        ...
        echo json_encode($datos);
        break;
        //TODO: Procedimeinto para eliminar registros del kardex en la base de datos en base al id
    case 'eliminar':
        $idKardex = $_POST["idKardex"];
        $datos = array();
